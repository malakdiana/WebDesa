      ...
      <div class="card-body">
        <form action="<?= $action ?>" id="form" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control form-control-sm" placeholder="Tgl meninggal" name="tgl_meninggal" id="tgl_meninggal">
          </div>

          <div class="form-group">
            <label>No dokumen</label>
            <input type="text" class="form-control form-control-sm" placeholder="No dokumen" name="no_dokumen" id="no_dokumen">
          </div>
