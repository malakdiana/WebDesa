    ...
    <div class="card m-b-30">
      ...
      <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="form-check">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="jenis_daerah" value="Kota">
                Kota
            ...
            <div class="form-check">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="jenis_daerah" value="Kabupaten">
                Kabupaten
                <i class="input-helper"></i>
              </label>
            </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-sm" placeholder="Kota / Kabupaten" name="kota" id="kota">
          </div>
          ...
          <div class="form-group">
            <label>Kodepos</label>
            <input type="number" class="form-control form-control-sm" placeholder="Kodepos" name="kodepos" id="kodepos">
          </div>
