      ...
      <div class="card-body">
        <form action="<?= $action ?>" id="form" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <select name="nik" id="nik" class="form-control form-control-sm select2">
          ...
          <div class="form-group">
            <label>Ket</label>
            <textarea class="form-control form-control-sm" placeholder="Ket" name="ket" id="ket" rows="3" cols="80"></textarea>
          </div>
