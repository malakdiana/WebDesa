      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="pull-right">
                          <a href="<?=url("dokumen/add")?>" class="btn btn-success btn-flat"><i class="fa fa-file btn-icon-prepend"></i> Add</a>
            ...
            <form autocomplete="off" class="content-filter">
              <div class="row">
                                  <div class="form-group col-md-6">
                                          <input type="text" id="nama_dokumen" class="form-control form-control-sm" placeholder="Nama dokumen" />
                                      </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({
      ...
      "ajax": {
        "url": "<?= url("dokumen/json")?>",
        "type": "POST",
         "data": function(data) {
                                          data.nama_dokumen = $("#nama_dokumen").val();
                                    }
              },
